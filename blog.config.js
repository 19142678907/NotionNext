...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个大学生, Hi，我是一个测绘人,Hi，我是一个干饭人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '零时', // 您的昵称 例如 tangly1024 
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-kappa-bice.vercel.app/', // 网站地址 
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '零时博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '2154769287@qq.com', // 邮箱地址 例如mail@tangly1024.com     
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页 
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://x.com/lei1254972', // 你的twitter个人主页 
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/19142678907', // 你的github个人主页 例如 https://github.com/tangly1024    
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/lsluckyboy', // 你的telegram 地址 例如 https://t.me/tangly_1024                
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://notion-next-kappa-bice.vercel.app', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || 'BnPjOzmWlQQJ6PxYJPIJ1',
  ...
  WIDGET_PET_LINK:
    ...
    'https://raw.githubusercontent.com/imuncle/live2d/master/model/22/model.2017.school.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-GZ1TQJR77Z', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'n0gzux2tj1', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
